      ...
      message.once('end', async () => {
        try {
          ...
          try {
            ...
            // The blacklist check is now performed centrally in the storage.createUrl() method
            // No need for duplicate code here - all URL creation goes through that central function
